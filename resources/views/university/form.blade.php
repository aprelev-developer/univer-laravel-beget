    ...
    <form method="POST" action="{{ route('university.submitForm') }}" enctype="multipart/form-data" id="form">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="program_theology" class="form-control"    >
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="state_accreditation" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="compliance_percentage" class="form-control" min="0" max="100" value="{{ old('compliance_percentage', $formEntry->data['compliance_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="test_results" class="form-control" min="0" max="100" value="{{ old('test_results', $formEntry->data['test_results'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="employment_rate" class="form-control" min="0" max="100" value="{{ old('employment_rate', $formEntry->data['employment_rate'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="full_time_students" class="form-control" min="0" value="{{ old('full_time_students', $formEntry->data['full_time_students'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="npr_coverage" class="form-control" min="0" max="100" value="{{ old('npr_coverage', $formEntry->data['npr_coverage'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="degree_holders_percentage" class="form-control" min="0" max="100" value="{{ old('degree_holders_percentage', $formEntry->data['degree_holders_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="grant_funding" class="form-control" min="0" value="{{ old('grant_funding', $formEntry->data['grant_funding'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="vak_publications_per_npr" class="form-control" min="0" step="0.01" value="{{ old('vak_publications_per_npr', $formEntry->data['vak_publications_per_npr'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="monographs_per_npr" class="form-control" min="0" step="0.01" value="{{ old('monographs_per_npr', $formEntry->data['monographs_per_npr'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="h_index_per_npr" class="form-control" min="0" step="0.01" value="{{ old('h_index_per_npr', $formEntry->data['h_index_per_npr'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="olympiad_winners" class="form-control" min="0" value="{{ old('olympiad_winners', $formEntry->data['olympiad_winners'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="patriotic_events" class="form-control" min="0" value="{{ old('patriotic_events', $formEntry->data['patriotic_events'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="website_compliance" class="form-control" min="0" max="100" value="{{ old('website_compliance', $formEntry->data['website_compliance'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="media_activity" class="form-control" min="0" value="{{ old('media_activity', $formEntry->data['media_activity'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="indigenous_students_percentage" class="form-control" min="0" max="100" value="{{ old('indigenous_students_percentage', $formEntry->data['indigenous_students_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="national_events_per_npr" class="form-control" min="0" step="0.01" value="{{ old('national_events_per_npr', $formEntry->data['national_events_per_npr'] ?? '') }}"    >
            </div>
            <div class="form-group">
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="internal_quality_system" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="professional_competitions" class="form-control" min="0" value="{{ old('professional_competitions', $formEntry->data['professional_competitions'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="npr_award_winners" class="form-control" min="0" value="{{ old('npr_award_winners', $formEntry->data['npr_award_winners'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="graduates_percentage" class="form-control" min="0" max="100" value="{{ old('graduates_percentage', $formEntry->data['graduates_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="postgraduate_percentage" class="form-control" min="0" max="100" value="{{ old('postgraduate_percentage', $formEntry->data['postgraduate_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="ebs_usage_percentage" class="form-control" min="0" max="100" value="{{ old('ebs_usage_percentage', $formEntry->data['ebs_usage_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="programs_availability" class="form-control" min="0" max="100" value="{{ old('programs_availability', $formEntry->data['programs_availability'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="eios_usage_percentage" class="form-control" min="0" max="100" value="{{ old('eios_usage_percentage', $formEntry->data['eios_usage_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="international_agreements" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="medrese_graduates_percentage" class="form-control" min="0" max="100" value="{{ old('medrese_graduates_percentage', $formEntry->data['medrese_graduates_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="non_scientific_publications" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="students_under_25_percentage" class="form-control" min="0" max="100" value="{{ old('students_under_25_percentage', $formEntry->data['students_under_25_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="students_from_muslim_orgs_percentage" class="form-control" min="0" max="100" value="{{ old('students_from_muslim_orgs_percentage', $formEntry->data['students_from_muslim_orgs_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="muslim_orgs_involved" class="form-control" min="0" value="{{ old('muslim_orgs_involved', $formEntry->data['muslim_orgs_involved'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="graduates_employed_in_muslim_orgs_percentage" class="form-control" min="0" max="100" value="{{ old('graduates_employed_in_muslim_orgs_percentage', $formEntry->data['graduates_employed_in_muslim_orgs_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="joint_events_with_muslim_orgs" class="form-control" min="0" value="{{ old('joint_events_with_muslim_orgs', $formEntry->data['joint_events_with_muslim_orgs'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="founders_funding_share" class="form-control" min="0" max="100" value="{{ old('founders_funding_share', $formEntry->data['founders_funding_share'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="donations_share" class="form-control" min="0" max="100" value="{{ old('donations_share', $formEntry->data['donations_share'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="paid_education_share" class="form-control" min="0" max="100" value="{{ old('paid_education_share', $formEntry->data['paid_education_share'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="scientific_events_held" class="form-control" min="0" value="{{ old('scientific_events_held', $formEntry->data['scientific_events_held'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="students_in_science_percentage" class="form-control" min="0" max="100" value="{{ old('students_in_science_percentage', $formEntry->data['students_in_science_percentage'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="has_educational_plan" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="lectures_by_foreign_scholars" class="form-control" min="0" value="{{ old('lectures_by_foreign_scholars', $formEntry->data['lectures_by_foreign_scholars'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="international_memberships" class="form-control" min="0" value="{{ old('international_memberships', $formEntry->data['international_memberships'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <select name="prepared_audiovisual_content" class="form-control"    >
                    <option value="">-- Выберите --</option>
        ...
        <div class="form-step">
            ...
            <div class="form-group">
                ...
                <input type="number" name="academic_exchanges_teachers" class="form-control" min="0" value="{{ old('academic_exchanges_teachers', $formEntry->data['academic_exchanges_teachers'] ?? '') }}"    >
            </div>
            <div class="form-group">
                <label>Загрузить файлы для данного пункта</label>

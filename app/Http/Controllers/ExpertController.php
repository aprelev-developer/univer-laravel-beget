...
class ExpertController extends Controller
{
    ...
    public function editForm($universityId)
    {
        ...
        $university = $expert->universities()
            ->where('expert_university.university_id', $universityId) // Указываем таблицу
            ->firstOrFail();
    ...
    public function updateForm(Request $request, $universityId)
    {
        ...
        return redirect()->route('expert.dashboard')->with(
            'success',
            'Форма успешно обновлена и редактирование закрыто.'
        );
    }
